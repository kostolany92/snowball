...
public class BusinessServiceImpl implements BusinessService {
	...
	public List<BusinessVo> listContent(BusinessSearchVo businessSearchVo) throws Exception {
		...
		if(listContent == null) {
			...
			URL url = new URL("https://dart.fss.or.kr/dsab007/detailSearch.ax?maxResults=100&sort=date&series=desc&textCrpNm=%EC%97%94%ED%94%BC%EC%94%A8&startDate=20160901&endDate=20210901&finalReport=recent&publicType=A001&publicType=A002&publicType=A003");
			...
			for(Element a : aList) {
				...
				// 사업의내용 추출
				url = new URL("http://dart.fss.or.kr/report/viewer.do?rcpNo=" + rcpNo + "&dcmNo=" + dcmNo + "&eleId=9&offset=58760&length=70999&dtd=dart3.xsd");
				con = (HttpURLConnection) url.openConnection();
				...
				if(content.indexOf("II. 사업의 내용") == -1) {
					url = new URL("http://dart.fss.or.kr/report/viewer.do?rcpNo=" + rcpNo + "&dcmNo=" + dcmNo + "&eleId=10&offset=58760&length=70999&dtd=dart3.xsd");
					con = (HttpURLConnection) url.openConnection();
